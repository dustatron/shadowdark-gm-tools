/**
 * SpellSearchInput Component
 *
 * Controlled search input with clear functionality for filtering spells.
...
interface SpellSearchInputProps {
   ...
   * @default "Search spells..."
   */
  placeholder?: string
}

/**
 * SpellSearchInput - Search input field with clear button
 *
 * Features:
  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <span id="search-hint" className="sr-only">
        Type to search spells by name. Press Escape to clear.
      </span>
    </div>
  )
}
